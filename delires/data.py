...
def create_blurred_and_noised_image(
    ...
    if save_path is not None:
        ...
        utils_image.imwrite(os.path.join(save_path, f"{img_name}{ext}"), degraded_img)
    else:
...
def generate_degraded_dataset_blurred(
    ...
    clean_dataset_path = os.join(DATADIR, clean_dataset_name)
    degraded_dataset_path = os.join(DATADIR, "degraded_datasets", degraded_dataset_name)
    
    # Load clean dataset
    clean_dataset = os.listdir(clean_dataset_path)
    os.makedirs(degraded_dataset_path, exist_ok=False)
